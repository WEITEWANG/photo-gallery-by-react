  ...
  */
  ...
  render() {
    ...
    imagesData.forEach((value, index) => {
      ...
      ImageFigures.push(<ImgFigure data={value} key={index} ref={'imageFigure' + index} arrange={this.state.imgsArrangeArr[index]} inverse={this.inverse(index)} center={this.center(index)} />);
